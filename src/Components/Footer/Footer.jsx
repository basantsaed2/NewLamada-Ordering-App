    ...
    <div className="w-full py-8 text-white footer bg-mainColor">
      <div className="w-full max-w-6xl px-5 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <Link to="https://apps.apple.com/eg/app/lamada/id6553989792" target='_blank' className="flex items-center px-4 py-2 space-x-4 transition duration-300 border border-white rounded-lg hover:bg-white hover:text-mainColor">
                <FaApple className="text-2xl" />
                <span className="text-sm">App Store</span>
              </Link>
          <Link to="https://drive.google.com/file/d/17ltn7x_qAqFzyofpvOEqtCLElFztwiIU/view?usp=sharing" target='_blank' className="flex items-center px-4 py-2 space-x-4 transition duration-300 border border-white rounded-lg hover:bg-white hover:text-mainColor">
