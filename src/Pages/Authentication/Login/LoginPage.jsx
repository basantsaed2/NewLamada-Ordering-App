...
const LoginPage = () => {
       ...
       const { postData: postEmail, loadingPost: loadingEmail, response: responseEmail } = usePost({ url: 'https://Lamadafoodbcknd.food2go.online/customer/otp/create_code' });
       const { postData: postPhone, loadingPost: loadingPhone, response: responsePhone } = usePost({ url: 'https://Lamadafoodbcknd.food2go.online/api/user/auth/signup/phone_code' });
       const { postData: postLogin, loadingPost: loadingLogin, response: responseLogin } = usePost({ url: 'https://Lamadafoodbcknd.food2go.online/api/user/auth/login' });
       const { postData: postNewLogin, loadingPost: loadingNewLogin, response: responseNewLogin } = usePost({ url: 'https://Lamadafoodbcknd.food2go.online/customer/otp/change_password' });
       ...
       return (
              <form onSubmit={handleLogin} className="flex items-center justify-center w-full h-screen mx-auto overflow-hidden">
                     <div className="flex flex-col items-start justify-start h-full sm:w-full gap-y-8">
                                   ...
                                   <>
                                                 ...
                                                 <>
                                                        ...
                                                        <div className={`${newPassState ? 'mt-16' : 'mt-5'} flex w-full flex-col items-start justify-start gap-y-4`}>
                                                               <span className='text-3xl xl:text-5xl font-TextFontRegular text-secoundColor'>
                                                                      {newPassState ? 'Set Your New Password' : 'Login to Lamada'}
                                                               </span>
                                                        </div>
                                                        <div className="flex flex-col justify-center w-full gap-y-10">
                                                               <div className="flex flex-col justify-center w-full gap-y-6">
                                                                      ...
                                                                      <div className="text-end">
                                                                             <button
                                                                                    type="button"
                                                                                    className="text-xl border-b-2 font-TextFontMedium text-mainColor border-mainColor"
                                                               ...
                                                               <div className="w-full">
                                                                      <span className='text-xl text-secoundColor font-TextFontRegular'>
                                                                             I Don't Have An Account? <Link to={'/auth/sign_up'} className='border-b-2 text-mainColor font-TextFontRegular border-mainColor'>SignUp</Link>
                                                                      </span>
                                                               </div>
                                                        </div>
                                                 </>
                                          ...
                                          {loginState === 'forgetPass' && (
                                                 <>
                                                        ...
                                                        <div className="flex flex-col items-start justify-start w-full mt-20 gap-y-4">
                                          ...
                                          {loginState === 'otp' && (
                                                 <>
                                                        ...
                                                        <div className="flex flex-col items-start justify-start w-full mt-5 gap-y-4">
                                                        ...
                                                        <div className="flex items-center justify-center w-8/12 mx-auto mt-12">
                                                               <InputOtp
                                                                      value={token}
