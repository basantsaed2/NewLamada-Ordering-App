              ...
              <>
                     <div className="flex flex-col items-center justify-center w-11/12 mx-auto gap-y-4">
                            ...
                            <div className="flex items-center justify-end w-full gap-5 sm:flex-col lg:flex-row">
                                   ...
                                   <Link to={'/menu'} className='px-16 py-2 text-center transition-all duration-300 ease-in-out bg-transparent border-2 sm:w-full lg:w-auto sm:text-xl xl:text-2xl text-mainColor rounded-2xl hover:bg-mainColor hover:text-white border-mainColor'
                                   >
                                          {t("BuyMore")}
                                   </Link>
                            </div>
