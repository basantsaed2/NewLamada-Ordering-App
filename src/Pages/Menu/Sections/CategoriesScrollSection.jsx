...
//        return (
//               <>
//                      <div className="flex flex-wrap items-center justify-start w-full gap-3 p-12">
//                             <div
...
const CategoriesScrollSection = () => {
    ...
    return (
        <div className="flex flex-col items-center w-screen gap-4 p-4 md:p-8">
            <Splide
                options ={{
                // type: 'slide',
            ...
            >
                ...
                <SplideSlide>
                    ...
                    >
                        ...
                        <span className="text-lg">{t("All")}</span>
                    </div>
                </SplideSlide>
