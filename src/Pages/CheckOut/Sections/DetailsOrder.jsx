            ...
            <div className="flex items-start justify-between w-full gap-5 p-3 bg-[#F4F4F4] sm:flex-col xl:flex-row rounded-2xl">
                        ...
                        <div className="flex items-start gap-4 sm:flex-col lg:flex-row">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    className="h-5 w-5 text-[#d7030b] focus:ring-[#d7030b] border-[#1f2937]"
                                />
                        ...
                        {timeMode === 'schedule' && (
                            <div className="min-w-[50%] max-w-[70%]">
                                <DropDown
                                    ...
                                    className="w-full p-2 text-xl border-2 outline-none border-[#F4F4F4] rounded-3xl focus:border-[#d7030b] text-[#1f2937] disabled:bg-[#F4F4F4] disabled:cursor-not-allowed sm:font-TextFontRegular xl:font-TextFontMedium"
                ...
                <div className="flex flex-col items-start justify-start gap-1 sm:w-full xl:w-6/12">
                    ...
                    <textarea
                        ...
                        rows={4}
                        className="w-full max-h-[10rem] p-2 text-xl border-2 outline-none border-[#A9A9A9] rounded-[24px] focus:border-[#d7030b] text-[#1f2937] sm:font-TextFontRegular xl:font-TextFontMedium resize-none overflow-auto"
                        value={note}
                        onChange={(e) => setNote(e.target.value)}
                    ></textarea>
                </div>
